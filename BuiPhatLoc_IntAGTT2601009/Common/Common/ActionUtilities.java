...
public class ActionUtilities {
	...
	public static void click_Action (WebElement webElement) {
	...
	public static void selectByVisibleText_Action (WebElement webElement, String selectOptionName) {
		Actions actions = new Actions(Constant.WEBDRIVER);
	...
	public static void selectByValue_Action(WebElement webElement, String selectValue) {
	    Actions actions = new Actions(Constant.WEBDRIVER);
	...
	public static void sendkey_Action(WebElement webElement, String keys) {
	    Actions actions = new Actions(Constant.WEBDRIVER);
	...
	public static void clickCheckBox_Action(WebElement webElement, boolean status) {
	    Actions actions = new Actions(Constant.WEBDRIVER);
